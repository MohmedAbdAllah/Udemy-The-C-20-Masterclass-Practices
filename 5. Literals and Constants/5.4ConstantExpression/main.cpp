...
int main(){
	...
	//Here we try to define constexpr by runtime variable
	//that will case error because it is not logic to define(at compile time) 
	//by variable that will get its value in future (runtime)
	...
	//Allows us to check for events at compile time
